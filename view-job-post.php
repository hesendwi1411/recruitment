      ...
      <div class="container">
        <div class="row">          
          <div class="col-md-9 bg-white padding-2">
            ...
            <?php 
            if(empty($_SESSION["id_user"]) && empty($_SESSION['companyLogged'])) { ?>
            <div>
              <a href="login-candidates-apply.php" class="btn btn-success btn-flat margin-top-50">Apply Now</a>
            </div> 
			
            <?php } 
			
			elseif(isset($_SESSION["id_user"]) && empty($_SESSION['companyLogged'])) { 
					
			?>
            <div>
              <a href="apply.php?id=<?php echo $row['id_jobpost']; ?>" class="btn btn-success btn-flat margin-top-50">Apply Now</a>
            </div>
              <?php } ?>
          </div>
          <div class="col-md-3">
