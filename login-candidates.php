...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form method="post" action="checklogin.php">
      ...
      <div class="row">
        <div class="col-xs-8">
          <a href="reset-candidates.php">I forgot my password</a>
        </div>
        <!-- /.col -->
        <div class="col-xs-4">
    ...
    if(isset($_SESSION['registerCompleted'])) {
      ?>
      <div>
        <p id="successMessage" class="text-center">You Have Registered Successfully! Please check your email to activite your Account</p>
      </div>
    <?php
