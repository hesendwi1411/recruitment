            ...
            ?>
              <div class="row">
                ...
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    <label for="qualification">College</label>
                    <input type="text" class="form-control input-lg" id="qualification" name="qualification" placeholder="College" value="<?php echo $row['qualification']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="stream">Majors</label>
                    <input type="text" class="form-control input-lg" id="stream" name="stream" placeholder="majors" value="<?php echo $row['stream']; ?>">
                  </div>
                  <div class="form-group">
                    <label>Skills</label>
