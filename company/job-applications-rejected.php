        ...
        <div class="row">
		  ...
		  <div class="pull-right">
            ...
            ?>
			 ...
			 <?php
             $sql = "SELECT *, apply_job_post.status as status FROM job_post INNER JOIN apply_job_post ON job_post.id_jobpost=apply_job_post.id_jobpost  INNER JOIN users ON users.id_user=apply_job_post.id_user WHERE apply_job_post.id_company='$_SESSION[id_company]' and apply_job_post.id_jobpost='$_GET[id]' and apply_job_post.status='1'";
                  $result = $conn->query($sql);
