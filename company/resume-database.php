                    ...
                    <?php
                      ...
                      <tr>
						...
						<td><?php echo $rpendidikan['nilai']; ?></td>							
							...
							<?php
							$id_user=$row['id_user'];
							$qdiagnosa=mysqli_query($conn,"SELECT * FROM pengalaman_kerja where id_user='$id_user'");
							while($rpengalaman=mysqli_fetch_array($qdiagnosa)){
							?>								
										
						<td><?php echo $rpengalaman['nama_perusahaan']; ?></td>
						<td><?php echo $rpengalaman['jabatan']; ?></td>	
						<td><?php echo $rpengalaman['gaji']; ?></td>							
							<?php
								}
							?>
                        <td>
