        ...
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>Candidates Database</i></h2>
				<form action="under-review-multiple.php" method="post">
			 <?php
			...
			<div class="pull-right">
                ...
                <button class="btn btn-default btn-lg btn-flat margin-top-20"><i class="fa fa-check"></i> Pilih</button>
              ...
              <div class="col-md-12">
                <div class="box-body table-responsive no-padding">
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                    <?php
                       $sql = "SELECT users.* FROM job_post INNER JOIN apply_job_post ON job_post.id_jobpost=apply_job_post.id_jobpost  INNER JOIN users ON users.id_user=apply_job_post.id_user WHERE apply_job_post.id_company='$_SESSION[id_company]' and apply_job_post.id_jobpost='$_GET[id]' GROUP BY users.id_user";
                            $result = $conn->query($sql);
                      ...
                      <tr>
						...
						<td align="center"><input type="checkbox" name="pilih[]" value="<?php echo $row['id_user']; ?>">
						<input type="hidden" name="id_jobpost" value="<?php echo $_GET['id']; ?>"></td>
                        <td><?php echo $row['firstname'].' '.$row['lastname']; ?></td>
						<td><?php echo $row['age']; ?></td>
						
							<?php
							$id_user=$row['id_user'];
							$qdiagnosa=mysqli_query($conn,"SELECT * FROM pendidikan where id_user='$id_user'");
							while($rpendidikan=mysqli_fetch_array($qdiagnosa)){
							?>								
										
						<td><?php echo $rpendidikan['jenjang'].'-'.$rpendidikan['nama_sekolah']; ?></td>
						<td><?php echo $rpendidikan['jurusan']; ?></td>	
