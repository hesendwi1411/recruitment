                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      <li><a href=""  class="citySearch" data-target="Yogyakarta"><i class="fa fa-circle-o text-yellow"></i> Yogyakarta</a></li>
                      <li><a href="" class="citySearch" data-target="Bantul"><i class="fa fa-circle-o text-yellow"></i> Bantul</a></li>
                    </ul>
                  </li>
                  <li class="treeview menu-open">
