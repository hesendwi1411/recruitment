  ...
  <div class="content-wrapper" style="margin-left: 0px;">
    ...
    <section class="content-header">
      <div class="container">
		...
		<div class="small-box bg-white padding-5">
              <div class="inner">
               
				<h3 class="text-center">!..WASPADA..!</h3>
			<h2 class="text-center" >Penipuan Lowongan Kerja</h2>
          ...
          <div class="col-md-6 latest-job ">
            <div class="small-box bg-yellow padding-5">
              <div class="inner">
                <h3 class="text-center">Login & Apply</h3>
              </div>
          ...
          <div class="col-md-6 latest-job ">
            <div class="small-box bg-red padding-5">
              <div class="inner">
                <h3 class="text-center">Register & Apply</h3>
              </div>
