            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
				  ...
				  <li class="active"><a href="users.php"><i class="fa fa-address-card-o"></i> Users</a></li>
                      ...
                      <tr>
                        ...
                        <?php
                          if($row['active'] == '1') {
                            ...
                            ?>
                            <a href="reject-user.php?id=<?php echo $row['id_user']; ?>">Reject</a> <a href="approve-user.php?id=<?php echo $row['id_user']; ?>">Approve</a>
                            <?php
