...
class CI_Email {
	...
	var	$smtp_host		= "lokal.ameyaindo.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "hesen@ameyaindo.com";		// SMTP Username
	var	$smtp_pass		= "yatmmiko";		// SMTP Password
